...
TOOLS = [
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {"query": {"type": "string", "description": "User query to be answered briefly"}},
            "required": ["query"],
        },
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {"query": {"type": "string", "description": "User query requiring in-depth research"}},
            "required": ["query"],
        },
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {"query": {"type": "string", "description": "Simple factual query"}},
            "required": ["query"],
        },
    },
]
...
async def root():
    ...
    return {
        ...
        "endpoints": {"sse": "/sse", "messages": "/messages/{session_id}"},
    }
...
async def handle_message(request: Request):
    ...
    try:
        ...
        logger.debug(
            f"Received message for session {session_id}: {message.get('method', 'no-method')} (id: {message.get('id', 'no-id')})"
        )
    except Exception as e:
        ...
        if method == "initialize":
            response = {
                ...
                "result": {
                    ...
                    "serverInfo": {"name": "reliable-test-mcp-server", "version": "1.0.0"},
                },
            }
