        ...
        try:
            ...
            if response.status_code == 200:
                ...
                try:
                    ...
                    print(f"   ✅ Immediate initialization response:")
                ...
                print(f"   ✅ Initialization accepted for async processing")
                return True
            else:
...
async def test_invalid_requests():
    ...
    async with httpx.AsyncClient(timeout=10.0) as client:
        ...
        print(f"🚫 Testing tools/list WITHOUT initialization...")
        
        tools_message = {
            "jsonrpc": "2.0",
            "id": "tools_list_no_init",
            "method": "tools/list",
            "params": {}
        }
