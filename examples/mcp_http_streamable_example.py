...
async def main() -> None:
    ...
    test_scenarios = [
        ...
        {"tool": "session_info", "args": {}, "description": "Get current HTTP session information"},
        {"tool": "http_counter", "args": {"increment": 3}, "description": "Increment session counter"},
        {"tool": "slow_operation", "args": {"duration": 2}, "description": "Test slow operation (may use streaming)"},
    ]
