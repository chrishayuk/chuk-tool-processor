...
class CHUKDiagnostic:
    ...
    async def run_full_diagnostic(self, gateway_url: str, auth_token: str | None = None):
        """
    ...
    async def _test_connection_setup(self, gateway_url: str, auth_token: str | None):
        ...
        try:
            ...
            self.test_results["connection"] = {"success": False, "setup_time": setup_time, "error": str(e)}
            raise
    ...
    async def _test_tool_discovery(self):
        ...
        try:
            ...
            for server in server_info:
                ...
                print(
                    f"   {status_icon} Server '{server['name']}': {server['tools']} tools, status: {server['status']}"
                )
            ...
            self.test_results["discovery"] = {"success": False, "discovery_time": discovery_time, "error": str(e)}
            raise
    ...
    async def _test_tool_execution(self):
        ...
        try:
            ...
            self.test_results["execution"] = {"success": False, "execution_time": execution_time, "error": str(e)}
    ...
    async def _analyze_performance(self):
        ...
        try:
            ...
            self.metrics_history.append({"timestamp": time.time(), "metrics": transport_metrics})

            self.test_results["performance"] = {"success": True, "transport_metrics": transport_metrics}
    ...
    async def _test_health_monitoring(self):
        ...
        try:
            ...
            self.test_results["health"] = {"success": True, "ping_results": ping_results}
        ...
        if "performance" in self.test_results and self.test_results["performance"].get("success"):
            ...
            for name, metrics in self.test_results["performance"]["transport_metrics"].items():
                ...
                if total_calls > 0:
                    ...
                    print(
                        f"   Transport '{name}': {total_calls} calls, {success_rate:.1f}% success, {avg_time:.3f}s avg"
                    )
            print()
...
async def main():
    ...
    GATEWAY_URL = (
        ...
        or "https://your-gateway-url"  # Default fallback
    )
