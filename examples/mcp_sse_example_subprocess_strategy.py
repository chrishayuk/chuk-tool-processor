...
Prerequisites:
- Run the test server first: python examples/reliable_test_sse_server.py
...
async def bootstrap_mcp() -> None:
    ...
    try:
        ...
        print("   python examples/reliable_test_sse_server.py")
        raise
...
async def run_demo() -> None:
    ...
    print("Start the test server with: python examples/reliable_test_sse_server.py")
