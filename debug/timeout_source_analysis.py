...
def analyze_timeout_sources():
    ...
    timeout_patterns = ["timeout=", "default_timeout", "wait_for(", "10.0", "30.0"]
    ...
    methods_to_check = ["_execute_single_call", "_run_with_timeout", "run", "stream_run"]
    ...
    if hasattr(StreamManager, "call_tool"):
        ...
        if "timeout" in sig.parameters:
            ...
            print("   -> ❌ No timeout parameter in call_tool")
    ...
    if hasattr(MCPTool, "__init__"):
        ...
        if "default_timeout" in init_sig.parameters:
            ...
            print("   -> ❌ No default_timeout parameter")
    ...
    if hasattr(MCPTool, "execute"):
        ...
        if "timeout" in execute_sig.parameters:
            ...
            print("   -> ❌ No timeout parameter in execute")
    ...
    if "default_timeout" in mcp_source:
        ...
        matching_lines = [
            (i + 1, line.strip()) for i, line in enumerate(lines) if "default_timeout" in line or "timeout" in line
        ]
