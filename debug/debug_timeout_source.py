    ...
    with patch("asyncio.wait_for", traced_wait_for):
        ...
        with patch("chuk_tool_processor.execution.strategies.inprocess_strategy.asyncio.wait_for", traced_wait_for):
            with patch("chuk_tool_processor.mcp.stream_manager.asyncio.wait_for", traced_wait_for):
                ...
                print("2. Testing 1 second timeout with comprehensive tracing...")
                ...
                test_call = ToolCall(
                    tool="perplexity_search", namespace="sse", arguments={"query": "Timeout tracing test"}
                )

                print(f"   Strategy default_timeout: {strategy.default_timeout}")
                print("   Executing with full timeout tracing...\n")
                ...
                try:
                    ...
                    result = await stream_manager.call_tool(
                        tool_name="perplexity_search", arguments={"query": "Direct StreamManager test"}
                    )
                ...
                if transport:
                    try:
                        ...
                        result = await transport.call_tool("perplexity_search", {"query": "Direct transport test"})
